...
static int MFVS_MakeScanPath (char* buffer, unsigned int buflen)
{
...
static long MFVS_DecodeAttachment(char* szScanFile, FILE* mailFile, mimeEncodingType encodingType)
{
...
static long MFUtil_EncodeFile(const char* szInFile, const char* szOutFile, mimeEncodingType encodingType)
{
...
static int MF_CheckWinmailDat(char* szAttFile, char* szTNEFFilename, MailFilter_MailData* m)
{
...
//CHANGE
							m->iTotalAttachmentSize += iThisAttSize;
							MF_CheckWinmailDat(szAttFile,szCmpBuffer,m);
						}
					}
				}
				break;
